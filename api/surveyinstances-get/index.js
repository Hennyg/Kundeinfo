...
module.exports = async function (context, req) {
  try {
    ...
    // HENT instances + template-navn som formatted value (lookup)
    const path =
      `crcc8_lch_surveyinstances` +
      `?$select=crcc8_lch_surveyinstanceid,crcc8_lch_code,crcc8_lch_customername,crcc8_expiresat,crcc8_status,createdon,_crcc8_lch_surveytemplate_value` +
