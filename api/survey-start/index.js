...
module.exports = async function (context, req) {
  try {
    ...
    const instPath =
      ...
      `?$select=cr175_lch_kundeinfo_kundeundersoegelseid,cr175_lch_kode,cr175_lch_kundenavn,cr175_lch_kundenummer,cr175_lch_udloebstidspunkt,cr175_lch_status,cr175_lch_mailsendttidspunkt` +
    ...
    return json(context, 200, {
      ...
      // "sidstsendtmailskabelon" er ikke oprettet som felt i Dataverse endnu
      // - når det er, skal linjen herunder ændres til at hente det rigtige
      // felt (cr175_lch_sidstsendtmailskabelon) igen, og feltet skal
      // tilføjes i $select ovenfor.
      mailTemplateUsed: null
    });
  } catch (err) {
